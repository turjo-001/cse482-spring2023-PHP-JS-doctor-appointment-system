...
$query = "SELECT * from appointments where completed=0 && dID = $id order by aptDate asc;";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($res = mysqli_fetch_array($result)) {
        ...
        echo "<td><form method='post'><button class='btn btn-success' type='submit' name='check-done' value='" . $res["aptID"] . "' onclick=\"return confirm('Are you sure you want to mark this appointment as done?');\">Mark as done</button></form></td>";
    };
    echo "</table>";
} else {
